    ...
    return (
        <>
            {loading ? (
                ...
                <div className="w-full h-full justify-center items-center flex flex-col p-6">
                    <div className="max-w-3xl flex flex-col items-center justify-between">
                        ...
                        <div className="flex flex-row gap-12 mb-6">
                            <img
                                src={pokemon.image}
                                alt={pokemon.name}
                                className="w-80 h-80 rounded-xl bg-white shadow-lg"
                            />
                        ...
                        <div className="flex-1 bg-white rounded-xl shadow-lg p-6 mb-6">
